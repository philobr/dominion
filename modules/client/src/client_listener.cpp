...
ClientListener::ClientListener(sockpp::tcp_connector *connection) { this->_connection = connection; }
...
void ClientListener::outputError(std::string title, std::string message)
{
