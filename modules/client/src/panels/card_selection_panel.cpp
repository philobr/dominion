...
namespace client
{
        ...
        wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(1024, 1024))
    {
        ...
        VerticalSizer->Add(GridSizer, 0, wxEXPAND | wxBOTTOM, 30);
    ...
    wxScrolledWindow *CardSelectionPanel::createCardSelection()
    {
        ...
        wxScrolledWindow *scrolledWindow =
                new wxScrolledWindow(this, wxID_ANY, wxDefaultPosition, wxSize(1000, 750), wxVSCROLL | wxHSCROLL);
        scrolledWindow->SetScrollRate(10, 15); // Set scroll rate in pixels

        // generated by OpenAI
        // Load the background image
        wxBitmap backgroundBitmap;
        wxString background_file = wxString("assets") + wxFileName::GetPathSeparator() + "wooden_background.png";
