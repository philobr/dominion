...
namespace client
{
    ...
    ConnectionPanel::ConnectionPanel(wxWindow *parent) : wxPanel(parent, wxID_ANY)
    {
        ...
        createLobbyButton->Bind(wxEVT_BUTTON, [](const wxCommandEvent &event) { GameController::connectToServer(); });
        ...
        joinLobbyButton->Bind(wxEVT_BUTTON, [](const wxCommandEvent &event) { GameController::connectToServer(); });
