...
namespace client
{
    ...
    void VictoryScreenPanel::drawVictoryScreen(reduced::GameState &gameState)
    {
        ...
        // Add the title
        wxStaticText *title = new wxStaticText(this, wxID_ANY, "Score", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER);
    ...
    void VictoryScreenPanel::drawTestVictoryScreen()
    {
        ...
        // Add the title
        wxStaticText* title = new wxStaticText(this, wxID_ANY, "https://www.youtube.com/watch?v=dQw4w9WgXcQ", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER);
        title->SetFont(wxFont(24, wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD));
        this->victory_screen_sizer->Add(title, 0, wxALIGN_CENTER, 10);
