...
namespace utils
{
    ...
    namespace assert_helpers
    {
        ...
        template <typename T>
        void log_assertion_failure(const T &actual, const T &expected, std::string_view op, std::string_view msg,
        ...
        template <typename T>
        void custom_assert(const T &actual, const T &expected, std::string_view op, std::string_view msg,
                           std::string_view file, int line, std::string_view function)
        {
#ifndef NDEBUG
