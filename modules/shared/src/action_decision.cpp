...
namespace shared {
    ...
    bool ActionDecision::operator!=(const ActionDecision& other) const
    {
        return !ActionDecision::operator==(other);
    }
    ...
    bool BuyCardDecision::operator==(const BuyCardDecision& other) const
    {
    ...
    bool EndTurnDecision::operator==(const EndTurnDecision& other) const
    {
        return true;
    }
